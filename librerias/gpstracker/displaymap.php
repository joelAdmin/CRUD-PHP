...
<head>
	...
	<script src="js/apiGoogleMap.js"></script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4" id="toplogo">
                <img id="halimage" src="images/gpstracker-man-blue-37.png">SISTEMA DE LOCALIZACI&Oacute;N GPS
            </div>
        ...
        <div class="row">
            <div class="col-sm-3 deletediv">
                <input type="button" id="delete" value="Borrar" tabindex="2" class="btn btn-primary">
            </div>
            ...
            <div class="col-sm-3 refreshdiv">
                <input type="button" id="refresh" value="Actualizar" tabindex="4" class="btn btn-primary">
            </div>
            <div class="col-sm-3 viewalldiv">
                <input type="button" id="viewall" value="Ver todos" tabindex="5" class="btn btn-primary">
            </div>
        </div>
    </div>       
</body>
